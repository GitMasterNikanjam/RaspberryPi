...
//
//    FILE: ADS1X15.h
//  AUTHOR: Mohammad Nikanjam. ----> Forked from Rob Tillaart
...
{
public:
  ADS1113(uint8_t address = ADS1115_ADDRESS, const char* i2c_device_path = "/dev/i2c-1");
};
...
{
public:
  ADS1114(uint8_t address = ADS1115_ADDRESS, const char* i2c_device_path = "/dev/i2c-1");
};
...
{
public:
  ADS1115(uint8_t address = ADS1115_ADDRESS, const char* i2c_device_path = "/dev/i2c-1");
  int16_t  readADC_Differential_0_3();
  int16_t  readADC_Differential_1_3();
  int16_t  readADC_Differential_2_3();
  int16_t  readADC_Differential_0_2();   //  not possible in async
