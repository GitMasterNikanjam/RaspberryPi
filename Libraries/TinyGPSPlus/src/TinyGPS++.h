// This Library forked from: https://github.com/mikalhart/TinyGPSPlus    "version": "1.0.3"
/*
TinyGPS++ - a small GPS library for Raspberry Pi providing universal NMEA parsing
Based on work by and "distanceBetween" and "courseTo" courtesy of Maarten Lamers.
Suggestion to add satellites, courseTo(), and cardinal() by Matt Monson.
Location precision improvements suggested by Wayne Holder.
Copyright (C) 2024-2025 Mohammad Nikanjam
All rights reserved.
...
public:
   ...
   uint32_t age() const    { return valid ? gps_millis() - lastCommitTime : (uint32_t)ULONG_MAX; }
